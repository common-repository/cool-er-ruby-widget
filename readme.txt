...
Once the plugin is enabled, the widget will be available in your widgets list as "Cool-er Ruby Widget". You can add this widget to sidebars as many times as you need. The control interface allows you to specify the following options for each instance of the widget:
...
The Cool-er Ruby Widget does not provide a mechanism for uploading images or files. You can however upload an image in the 'Write' section of WordPress. From there you can click on the 'Add an Image' icon (next to 'Add Media' label). After uploading an image, copy the 'Link URL' for use in your Cool-er Ruby Widget.
...
`.coolerruby { text-align: center; }
.coolerruby { margin:0 auto; }
.coolerruby { margin:0 auto; text-align: center; }
.coolerruby { margin:0 auto; text-align: left; }
.coolerruby { margin-top:0px; margin-right:0px; margin-bottom:0px; margin-left:0px; }`
